...
exports.handler = async (event) => {
  ...
  try {
    ...
    const groupOneTwo = {
      content:
        "```아르테미스, 욘, 베른 북부, 베른 남부, 페이튼, 루테란 동부, 유디아, 애니츠, 슈샤이어 9개 지역입니다```",
    };

    const groupOneThree = {
      content:
        "```아르테미스, 욘, 베른 북부, 베른 남부, 루테란 서부, 루테란 동부, 토토이크, 아르데타인, 로헨델, 파푸니카 10개 지역입니다```",
    };
    ...
    const discordUrl = "DISCORD UPDATE Abre Server";
